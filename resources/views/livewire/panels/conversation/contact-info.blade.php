<div id="Info-Panel"
    ...
    <div class="p-4" x-data="{ clientForm: false }">
        ...
        <div x-show="$store.forms.createFormVisible" x-cloak
            ...
            <div
                class="relative bg-white rounded-lg shadow-xl mx-auto max-w-lg w-[400px] transform transition-all mt-20 z-50 p-6 duration-300">
