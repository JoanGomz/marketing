        ...
        <div class="space-y-4">
            ...
            <div class="pt-4 border-t flex flex-col gap-4">
                ...
                <div class="text-sm p-2 bg-gray-50 rounded border">
                    <div class="text-xs text-gray-500">Usuario con problemas frecuentes en la recarga por PSE. revisar</div>
                </div>
                <textarea class="w-full p-2 border rounded-md text-sm" rows="2" placeholder="Agregar notas..."></textarea>
            </div>
        </div>
        <div>
            ...
            <div class="pt-4">
                ...
                <div class="space-y-2">
                    <div class="text-sm p-2 bg-gray-50 rounded border">
                        ...
                        <div class="text-xs text-gray-500">Bienvenido a la atención en linea de StarPark, ¿En que podemos ayudarte? ¿Desde que sede te comunicas?</div>
                    </div>
                    <div class="text-sm p-2 bg-gray-50 rounded border">
                        <div class="font-medium">#Finalizar conversación</div>
                        <div class="text-xs text-gray-500">Para nosotros es un placer ayudarte, a continuación te brindaremos una encuesta para que puedas calificar nuestra atención.</div>
                    </div>
                </div>
            </div>
        </div>
