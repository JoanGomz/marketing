<div
    x-data="{
        ...
        showModal(detail) {
            ...
            this.itemName = detail.name || 'este elemento';
            this.open = true;
        },
        hideModal() {
            this.open = false;
    ...
    x-on:show-delete-modal.window="showModal($event.detail)"
    @keydown.escape.window="hideModal()"
    x-cloak
    class="fixed inset-0 z-50 x-50 overflow-y-auto"
    x-show="open"
    style="display: none;"
>
<div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center  sm:p-0">
        ...
        >
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                ¿Estás seguro de querer eliminar <span x-text="itemName"></span>? Esta acción no se puede deshacer.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-center bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button 
                    type="button" 
                    @click="$wire.delete(itemId); hideModal();window.dispatchEvent(new CustomEvent('show-loading', { 
